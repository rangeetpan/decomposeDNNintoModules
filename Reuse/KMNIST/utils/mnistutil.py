...
class MNISTUitl:
    ...
    # the data, split between train and test sets
        x_train1 = self.load('kmnist-train-imgs.npz')
        x_test1 = self.load('kmnist-test-imgs.npz')
        y_train1 = self.load('kmnist-train-labels.npz')
        y_test1 = self.load('kmnist-test-labels.npz')
        x_train2 = self.load('kmnist-train-imgs.npz')
        x_test2= self.load('kmnist-test-imgs.npz')
        y_train2 = self.load('kmnist-train-labels.npz')
        y_test2 = self.load('kmnist-test-labels.npz')
