...
for k in range(0,10):
    for j in range(0,10):
        ...
        if(class2==0):
            Mmodule0=load_model('Kmodule0.h5')
        if(class2==1):
            Mmodule0=load_model('Kmodule1.h5')
        if(class2==2):
            Mmodule0=load_model('Kmodule2.h5')
        if(class2==3):
            Mmodule0=load_model('Kmodule3.h5')
        if(class2==4):
            Mmodule0=load_model('Kmodule4.h5')
        if(class2==5):
            Mmodule0=load_model('Kmodule5.h5')
        if(class2==6):
            Mmodule0=load_model('Kmodule6.h5')
        if(class2==7):
            Mmodule0=load_model('Kmodule7.h5')
        if(class2==8):
            Mmodule0=load_model('Kmodule8.h5')
        if(class2==9):
            Mmodule0=load_model('Kmodule9.h5')
