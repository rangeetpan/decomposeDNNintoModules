...
for pair in itertools.combinations(labs,2):
        ...
        if(class2==1):
            Mmodule0=load_model('Fmodule1.h5')
        if(class2==2):
            Mmodule0=load_model('Fmodule2.h5')
        if(class2==3):
            Mmodule0=load_model('Fmodule3.h5')
        if(class2==4):
            Mmodule0=load_model('Fmodule4.h5')
        if(class2==5):
            Mmodule0=load_model('Fmodule5.h5')
        if(class2==6):
            Mmodule0=load_model('Fmodule6.h5')
        if(class2==7):
            Mmodule0=load_model('Fmodule7.h5')
        if(class2==8):
            Mmodule0=load_model('Fmodule8.h5')
        if(class2==9):
            Mmodule0=load_model('Fmodule9.h5')

        if(class1==0):
            Fmodule0=load_model('Fmodule0.h5')
        if(class1==1):
            Fmodule0=load_model('Fmodule1.h5')
        if(class1==2):
            Fmodule0=load_model('Fmodule2.h5')
        if(class1==3):
            Fmodule0=load_model('Fmodule3.h5')
        if(class1==4):
            Fmodule0=load_model('Fmodule4.h5')
        if(class1==5):
            Fmodule0=load_model('Fmodule5.h5')
        if(class1==6):
            Fmodule0=load_model('Fmodule6.h5')
        if(class1==7):
            Fmodule0=load_model('Fmodule7.h5')
        if(class1==8):
            Fmodule0=load_model('Fmodule8.h5')
        if(class1==9):
            Fmodule0=load_model('Fmodule9.h5')
        sx = 28
        sy = 28
        # class1=0
        # class2=0
