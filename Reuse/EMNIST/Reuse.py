...
for pair in itertools.combinations(labs,2):
        ...
        if(class2==0):
            Mmodule0=load_model('Emodule0.h5')
        if(class2==1):
            Mmodule0=load_model('Emodule1.h5')
        if(class2==2):
            Mmodule0=load_model('Emodule2.h5')
        if(class2==3):
            Mmodule0=load_model('Emodule3.h5')
        if(class2==4):
            Mmodule0=load_model('Emodule4.h5')
        if(class2==5):
            Mmodule0=load_model('Emodule5.h5')
        if(class2==6):
            Mmodule0=load_model('Emodule6.h5')
        if(class2==7):
            Mmodule0=load_model('Emodule7.h5')
        if(class2==8):
            Mmodule0=load_model('Emodule8.h5')
        if(class2==9):
            Mmodule0=load_model('Emodule9.h5')
