...
class MNISTUitl:
    ...
    # the data, split between train and test sets
        x_train1 = self.load('emnist-train-imgs.npz')
        x_test1 = self.load('emnist-test-imgs.npz')
        y_train1 = self.load('emnist-train-labels.npz')
        y_test1 = self.load('emnist-test-labels.npz')
        ...
        for i in range(0,len(y_train1)):
            y_train1[i]=y_train1[i]-1
        for i in range(0,len(y_test1)):
            y_test1[i]=y_test1[i]-1
