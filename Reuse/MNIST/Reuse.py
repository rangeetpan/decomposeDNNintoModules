...
for pair in itertools.combinations(labs,2):
        ...
        if(class1==0):
            Fmodule0=load_model('Mmodule0.h5')
        if(class1==1):
            Fmodule0=load_model('Mmodule1.h5')
        if(class1==2):
            Fmodule0=load_model('Mmodule2.h5')
        if(class1==3):
            Fmodule0=load_model('Mmodule3.h5')
        if(class1==4):
            Fmodule0=load_model('Mmodule4.h5')
        if(class1==5):
            Fmodule0=load_model('Mmodule5.h5')
        if(class1==6):
            Fmodule0=load_model('Mmodule6.h5')
        if(class1==7):
            Fmodule0=load_model('Mmodule7.h5')
        if(class1==8):
            Fmodule0=load_model('Mmodule8.h5')
        if(class1==9):
            Fmodule0=load_model('Mmodule9.h5')
        sx = 28
        sy = 28
        # class1=0
        # class2=0
