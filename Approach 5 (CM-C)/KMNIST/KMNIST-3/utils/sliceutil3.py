...
class Slice:
    ...
    def backtrack (self, intent):
        ...
        #     temp1=[]
        #     temp2=[]
        #     if(self.D4[i,intent]<0.05 and self.D4[i,intent]>-0.05):
        #         #print('yipee')
        #         for j in range(0,10):
        #             if(j!=intent):
        #                 if(self.D4[i,j]!=0):
        #                     temp1.append(self.D4[i,j])
        #                     temp2.append(j)
        #         if(intent==0):
                    
        #             self.D4[i,1]=np.mean(temp1)
        #             if(np.isnan(self.D4[i,1])):
        #                 self.D4[i,1]=0
                    
        #             for k in temp2:
        #                 self.D4[i,k]=0
        #         else:
        #             self.D4[i,0]=np.mean(temp1)
        #             if(np.isnan(self.D4[i,0])):
        #                 self.D4[i,0]=0
        #             for k in temp2:
        #                 self.D4[i,k]=0
        #         tempD4.append(i)
        ...
        #             #print(a)
        #             #print(len(tempD2))
        #         self.D4[tempD4[0],1]=a/len(tempD4)
        #         if(np.isnan(self.D4[tempD4[0],1])):
        #                 self.D4[tempD4[0],1]=0
        #         for x in tempD4[1:len(tempD4)]:
        #             self.D4[x,1]=0
        #             #self.d3[x]=0
        #     else:
        #         a=0
        #         for i in tempD4:
        #             a+=self.D4[i,1] 
        #         self.D4[tempD4[0],0]=a/len(tempD4)
        #         if(np.isnan(self.D4[tempD4[0],0])):
        #             self.D4[tempD4[0],0]=0
        #         for x in tempD4[1:len(tempD4)]:
        #             #print(tempD3)
        #             self.D4[x,0]=0
        #             #print(x)
        ...
        #     tempD3=[]
        #     for j in tempD4:
        #         tempD3.append(self.D3[i,j])
        #     self.D3[i,tempD4[0]]=np.mean(tempD3)
        #     #print(np.mean(tempD3))
        #     if(np.isnan(self.D3[i,tempD4[0]])):
        #             self.D3[i,tempD4[0]]=0
        #     for x in tempD4[1:len(tempD4)]:
        #             self.D3[i,x]=0
        ...
        for i in range(self.D4.shape[0]):
            ...
            self.D4[i,:]=temp
        if(intent==0):
            self.d4[1]=np.mean(self.d4[1:10])
            self.d4[2:10]=0
        else:
            self.d4[0]=np.mean(tempB4)
            for j in range(1,10):
                    if(j!=intent):
                        self.d4[j]=0
        ...
        for i in range(self.D4.shape[0]):
            temp=[]
            if(intent==0):
                if(self.D4[i,0]==0 and self.D4[i,1]!=0):
                    temp.append(i)
            else:
                if(self.D4[i,0]!=0 and self.D4[i,intent]==0):
                    temp.append(i)
        #counter=0
        if(len(temp)>0):
            ...
            if(intent==0):
                ...
                tempd4=[]
                for x in temp:
                    tempD4.append(self.D4[x,1])
                    tempd4.append(self.d4[x])
                self.D4[temp[0],1]=np.mean(tempD4)
                self.d4[temp[0]]=np.mean(tempd4)
            ...
            if(intent!=0):
                ...
                for x in temp:
                    tempD4.append(self.D4[x,1])
                    tempd4.append(self.d4[x])
                self.D4[temp[0],0]=np.mean(tempD4)
                self.d4[temp[0]]=np.mean(tempd4)
                for x in temp[1:len(temp)]:
                    self.D4[x,0]=0
                    self.d4[x]=0
            for i in range(self.D3.shape[0]):
                self.D3[i:temp[0]]=np.mean(self.D3[i,:] for j in temp)
                for x in temp[1:len(temp)]:
                    self.D3[i:x]=0
