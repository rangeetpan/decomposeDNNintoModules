...
class Slice:
    ...
    def backtrack (self, intent):
        ...
        #     temp1=[]
        #     temp2=[]
        #     if(self.D2[i,intent]<0.05 and self.D2[i,intent]>-0.05):
        #         #print('yipee')
        #         for j in range(0,10):
        #             if(j!=intent):
        #                 if(self.D2[i,j]!=0):
        #                     temp1.append(self.D2[i,j])
        #                     temp2.append(j)
        #         if(intent==0):
                    
        #             self.D2[i,1]=np.mean(temp1)
        #             if(np.isnan(self.D2[i,1])):
        #                 self.D2[i,1]=0
                    
        #             for k in temp2:
        #                 self.D2[i,k]=0
        #         else:
        #             self.D2[i,0]=np.mean(temp1)
        #             if(np.isnan(self.D2[i,0])):
        #                 self.D2[i,0]=0
        #             for k in temp2:
        #                 self.D2[i,k]=0
        #         tempD2.append(i)
        ...
        #             #print(a)
        #             #print(len(tempD2))
        #         self.D2[tempD2[0],1]=a/len(tempD2)
        #         if(np.isnan(self.D2[tempD2[0],1])):
        #                 self.D2[tempD2[0],1]=0
        #         for x in tempD2[1:len(tempD2)]:
        #             self.D2[x,1]=0
        #             #self.d3[x]=0
        #     else:
        #         a=0
        #         for i in tempD2:
        #             a+=self.D2[i,1] 
        #         self.D2[tempD2[0],0]=a/len(tempD2)
        #         if(np.isnan(self.D2[tempD2[0],0])):
        #             self.D2[tempD2[0],0]=0
        #         for x in tempD2[1:len(tempD2)]:
        #             #print(tempD3)
        #             self.D2[x,0]=0
        #             #print(x)
        ...
        #         tempD1=[]
        #         for j in tempD2:
        #             tempD1.append(self.D1[i,j])
        #         self.D1[i,tempD2[0]]=np.mean(tempD1)
        #         #print(np.mean(tempD1))
        #         if(np.isnan(self.D1[i,tempD2[0]])):
        #                 self.D1[i,tempD2[0]]=0
        #         for x in tempD2[1:len(tempD2)]:
        #                 self.D1[i,x]=0
        ...
        for i in range(self.D2.shape[0]):
            temp=[]
            if(intent==0):
                if(self.D2[i,0]==0 and self.D2[i,1]!=0):
                    temp.append(i)
            else:
                if(self.D2[i,0]!=0 and self.D2[i,intent]==0):
                    temp.append(i)
        # #counter=0
        # if(len(temp)>0):
        ...
        #         tempd2=[]
        #         for x in temp:
        #             tempD2.append(self.D2[x,1])
        #             tempD2.append(self.d2[x])
        #         self.D2[temp[0],1]=np.mean(tempD2)
        #         self.d2[temp[0]]=np.mean(tempd2)
        ...
        #             tempD2.append(self.D2[x,1])
        #             tempD2.append(self.d2[x])
        #         self.D2[temp[0],0]=np.mean(tempD2)
        #         self.d2[temp[0]]=np.mean(tempd2)
        #         for x in temp[1:len(temp)]:
        #             self.D2[x,0]=0
        #             self.d2[x]=0
        #     for i in range(self.D1.shape[0]):
        #         self.D1[i:temp[0]]=np.mean(self.D1[i,:] for j in temp)
        #         for x in temp[1:len(temp)]:
        #             self.D1[i:x]=0
