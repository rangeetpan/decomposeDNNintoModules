...
import numpy as np
#Module Load
module0=load_model('OtherModules/module0.h5')
module1=load_model('OtherModules/module1.h5')
module2=load_model('OtherModules/module2.h5')
module3=load_model('OtherModules/module3.h5')
module4=load_model('OtherModules/module4.h5')
module5=load_model('ReplaceModule/module5.h5')
module6=load_model('OtherModules/module6.h5')
module7=load_model('OtherModules/module7.h5')
module8=load_model('OtherModules/module8.h5')
module9=load_model('OtherModules/module9.h5')
